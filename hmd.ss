        ...
        (L (V countdown1-rec)
          (L (V countdown2-rec)
            (L (V x)
              (If (A (A (V ==) (V x)) (K 0))
                (K 0)
                (A (V countdown1-rec) (A (A (V -) (V x)) (K 1))))))))
      (Forall ((TV a) (TV c))
        (PT Fun ((TV a)
                 (PT Fun ((PT Fun ((C Int) (C Int)))
                          (PT Fun ((TV c)
        ...
        (L (V countdown1-rec)
          (L (V countdown2-rec)
            (L (V x)
              (If (A (A (V ==) (V x)) (K 0))
                (K 0)
                (A (V countdown2-rec) (A (A (V -) (V x)) (K 1))))))))
      (Forall ((TV a) (TV b))
        (PT Fun ((TV a)
                 (PT Fun ((TV b)
                          (PT Fun ((PT Fun ((C Int) (C Int)))
        ...
        (L (V countdown1-rec)
          (L (V countdown2-rec)
            (L (V x)
              (If (A (A (V ==) (V x)) (K 0))
                (K 0)
                (A (V countdown0-rec) (A (A (V -) (V x)) (K 1))))))))
      (Forall ((TV b) (TV c))
        (PT Fun ((PT Fun ((C Int) (C Int)))
                 (PT Fun ((TV b)
                          (PT Fun ((TV c)
                                   (PT Fun ((C Int) (C Int)))))))))) ,testpred-closure)
    (countdown0 (Fixn (K 0) (PT FixList ((V countdown0-rec) (V countdown1-rec) (V countdown2-rec))))
      (PT Fun ((C Int) (C Int))) ,testpred-closure)
    (countdown1 (Fixn (K 1) (PT FixList ((V countdown0-rec) (V countdown1-rec) (V countdown2-rec))))
      (PT Fun ((C Int) (C Int))) ,testpred-closure)
